...
// on some compilers (GCC/Clang) you can use __uint128_t for 128‑bit intermediate
// but it is not available with MSVC.  We'll avoid it and do a safe modular
// multiplication with a simple loop that never overflows a 64‑bit value.
using u64  = uint64_t;

// Multiplicación modular segura para evitar overflow sin tipos de 128 bits
